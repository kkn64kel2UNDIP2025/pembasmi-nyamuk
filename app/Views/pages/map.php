    ...
    <div class="relative p-4 w-full max-w-2xl max-h-[96vh]" onclick="event.stopPropagation()">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                ...
                <button type="button" onclick="closeDetailModal()" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
    ...
    locations.forEach(location => {
        ...
        const popupContent = `
                <div class="p-4 min-w-60 font-sans">
                    ...
                    <button onclick="openDetailModal('${location.id}')" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                        Lihat Detail
                    </button>
                    </div>
                </div>
